...
示例:
    python mysql_to_pgsql_converter.py ../bpm-2025-03-30.sql bpm-data.sql
"""
...
class MySQLToPostgreSQLConverter:
    ...
    def __init__(self, tables: Optional[List[str]] = None):
        ...
        """
        self.tables = tables or self.BPM_TABLES
        self.stats = {
            'total_lines': 0,
            'insert_statements': 0,
            'converted': 0,
    ...
    def _apply_conversions(self, sql: str) -> str:
        ...
        # b'0' -> false, b'1' -> true
        # 注意：需要先运行 bpm-upgrade-2025-12-02.sql 将 smallint 列改为 boolean
 ...
 Source: bpm-2025-03-30.sql (MySQL)
 Target: PostgreSQL
...
def main():
    ...
    parser.add_argument(
        ...
        nargs='+',
        default=None,
        help='Specific tables to convert (default: all BPM tables)'
    )
    parser.add_argument(
        '-v', '--verbose',
        action='store_true',
