...
import cn.iocoder.yudao.module.srm.api.product.ErpProductUnitApi;
...
public class CrmBusinessController {
    ...
    private CrmBusinessRespVO buildBusinessDetail(CrmBusinessDO business) {
        ...
        Map<Long, ErpProductDTO> erpProductMap = erpProductApi.getProductMap(convertSet(businessProducts, CrmBusinessProductDO::getProductId));
