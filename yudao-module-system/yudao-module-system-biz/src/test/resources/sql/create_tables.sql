...
-- 将该建表 SQL 语句，添加到 yudao-module-weapp-biz 模块的 test/resources/sql/create_tables.sql 文件里
CREATE TABLE IF NOT EXISTS "weapp_apps_list" (
 "id" int NOT NULL GENERATED BY DEFAULT AS IDENTITY,
 "weapp_name" varchar NOT NULL,
 "weapp_openid" varchar NOT NULL,
