...
public class SmsLogServiceImpl implements SmsLogService {
    ...
    public void updateSmsSendResult(Long id, Integer sendCode, String sendMsg,
        ...
        SysSmsSendStatusEnum sendStatus = CommonResult.isSuccess(sendCode) ?
                SysSmsSendStatusEnum.SUCCESS : SysSmsSendStatusEnum.FAILURE;
        smsLogMapper.updateById(SysSmsLogDO.builder().id(id).sendStatus(sendStatus.getStatus())
    ...
    public void updateSmsReceiveResult(Long id, Boolean success, Date receiveTime,
        ...
        SysSmsReceiveStatusEnum receiveStatus = Objects.equals(success, true) ?
                SysSmsReceiveStatusEnum.SUCCESS : SysSmsReceiveStatusEnum.FAILURE;
        smsLogMapper.updateById(SysSmsLogDO.builder().id(id).receiveStatus(receiveStatus.getStatus())
