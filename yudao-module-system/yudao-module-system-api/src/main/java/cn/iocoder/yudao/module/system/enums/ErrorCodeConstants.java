...
public interface ErrorCodeConstants {
    ...
    ErrorCode USER_NUMBER_EXISTS = new ErrorCode(1_002_003_013, "工号已存在");
    ...
    ErrorCode DEPT_IS_TOP = new ErrorCode(1_002_004_008, "部门({})已是顶级部门");
    ...
    // ========== 字典数据 1-002-007-000 ==========
    ErrorCode DICT_DATA_NOT_EXISTS = new ErrorCode(1_002_007_001, "当前字典数据({})不存在");
