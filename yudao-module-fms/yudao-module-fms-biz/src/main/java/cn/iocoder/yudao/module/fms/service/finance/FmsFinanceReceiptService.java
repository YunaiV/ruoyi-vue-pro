 ...
 * @author 芋道源码
 */
public interface FmsFinanceReceiptService {
     ...
     * @return 编号
     */
    Long createFinanceReceipt(@Valid FmsFinanceReceiptSaveReqVO createReqVO);
     ...
     */
    void updateFinanceReceipt(@Valid FmsFinanceReceiptSaveReqVO updateReqVO);
     ...
     * @return 收款单
     */
    FmsFinanceReceiptDO getFinanceReceipt(Long id);
     ...
     * @return 收款单分页
     */
    PageResult<FmsFinanceReceiptDO> getFinanceReceiptPage(FmsFinanceReceiptPageReqVO pageReqVO);
     ...
     * @return 收款单项列表
     */
    List<FmsFinanceReceiptItemDO> getFinanceReceiptItemListByReceiptId(Long receiptId);
     ...
     * @return 收款单项 List
     */
    List<FmsFinanceReceiptItemDO> getFinanceReceiptItemListByReceiptIds(Collection<Long> receiptIds);
