package cn.iocoder.mudule.fms.dal.redis.no;

import cn.hutool.core.date.DatePattern;
import cn.hutool.core.date.DateUtil;
import cn.hutool.core.text.StrPool;
import cn.iocoder.mudule.fms.dal.redis.FmsRedisKeyConstants;
...
public class FmsNoRedisDAO {
    ...
    /**
     * 付款单 {@link cn.iocoder.mudule.fms.dal.dataobject.finance.ErpFinancePaymentDO}
     */
    public static final String FINANCE_PAYMENT_NO_PREFIX = "FKD";
    /**
     * 收款单 {@link cn.iocoder.mudule.fms.dal.dataobject.finance.ErpFinanceReceiptDO}
     */
