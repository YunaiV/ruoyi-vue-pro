...
public class CollectionUtils {
    ...
    // map each element in collection using function
    ...
    // produce a map where key are generated by keyFunc, and value is the list of collection member sharing the same key
