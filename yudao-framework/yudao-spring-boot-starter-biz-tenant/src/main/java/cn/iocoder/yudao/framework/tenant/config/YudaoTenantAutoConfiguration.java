...
public class YudaoTenantAutoConfiguration {
    ...
    @Bean
    public TenantLineInnerCustomizer baseTenantLineInnerCustomizer(TenantProperties properties) {
        return interceptor -> {
            try {
                // 获取配置中扫描所有的包
                ...
                for (Resource res : resources) {
                    ...
                    if (clazz.isAnnotationPresent(IgnoreTenantDB.class)) {
                        // 找到带有 @IgnoreTenantDB 注解的类
