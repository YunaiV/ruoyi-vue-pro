...
- **精简版**：只包括系统功能、基础设施功能，适合快速开发简单的管理系统

> 💡 **迁移提示**：参考 [《迁移文档》](https://doc.iocoder.cn/migrate-module/)，只需 5-10 分钟即可将完整版按需迁移到精简版
...
<p align="center">
  <img src="/.image/common/ruoyi-vue-pro-architecture.png" alt="架构图" />
</p>
...
- **管理后台**：
  - 电脑端：Vue3 提供 `element-plus`、`vben(ant-design-vue)` 两个版本，Vue2 提供 `element-ui` 版本
  - 移动端：采用 `uni-app` 方案，一份代码多终端适配，同时支持 APP、小程序、H5
- **后端架构**：Spring Boot 多模块架构、MySQL + MyBatis Plus、Redis + Redisson
...
- ✅ **动态权限**：支持加载动态权限菜单，按钮级别权限控制，Redis 缓存提升性能
- ✅ **多租户**：支持 SaaS 多租户，可自定义每个租户的权限，提供透明化的多租户底层封装
- ✅ **工作流**：Flowable 工作流，支持动态表单、在线设计流程、会签/或签、多种任务分配方式
- ✅ **代码生成**：一键生成 Java、Vue 前后端代码、SQL 脚本、接口文档，支持单表、树表、主子表
- ✅ **实时通信**：Spring WebSocket 实现，内置 Token 身份校验，支持 WebSocket 集群
- ✅ **第三方集成**：微信小程序、微信公众号、企业微信、钉钉等三方登陆，支付宝、微信等支付与退款
- ✅ **云服务集成**：阿里云、腾讯云等短信渠道，MinIO、阿里云、腾讯云、七牛云等云存储服务
- ✅ **数据可视化**：集成报表设计器、大屏设计器，通过拖拽即可生成酷炫的报表与大屏

##  🐳 项目关系

<p align="center">
  <img src="/.image/common/yudao-roadmap.png" alt="架构演进" />
</p>
...
**① 开源协议友好**
- 采用比 Apache 2.0 更宽松的 [MIT License](https://gitee.com/zhijiantianya/ruoyi-vue-pro/blob/master/LICENSE) 开源协议
- 个人与企业可 100% 免费使用，不用保留类作者、Copyright 信息

**② 代码完全开源**
- 代码全部开源，不会像其他项目一样，只开源部分代码
- 让你无法了解整个项目的架构设计
- 详见 [国产开源项目对比](https://www.yuque.com/xiatian-bsgny/lm0ec1/wqf8mn)

<p align="center">
  <img src="/.image/common/project-vs.png" alt="开源项目对比" />
</p>
...
<p align="center">
  <img src="/.image/common/ruoyi-vue-pro-biz.png" alt="功能分层" />
</p>
...
<p align="center">
  <img src="/.image/common/system-feature.png" alt="系统功能图" />
</p>

### 🔄 工作流程

<p align="center">
  <img src="/.image/common/bpm-feature.png" alt="工作流功能图" />
</p>
...
<p align="center">
  <img src="/.image/common/infra-feature.png" alt="基础设施功能图" />
</p>
...
<p align="center">
  <img src="/.image/common/mall-feature.png" alt="商城功能图" />
</p>

<p align="center">
  <img src="/.image/common/mall-preview.png" alt="商城预览图" />
</p>
...
<p align="center">
  <img src="/.image/common/erp-feature.png" alt="ERP功能图" />
</p>
...
<p align="center">
  <img src="/.image/common/crm-feature.png" alt="CRM功能图" />
</p>
...
<p align="center">
  <img src="/.image/common/ai-feature.png" alt="AI功能图" />
</p>

<p align="center">
  <img src="/.image/common/ai-preview.gif" alt="AI预览图" />
</p>
