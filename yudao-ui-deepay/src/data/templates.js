...
export const templates = [
  ...
  ───────────────────────────────────────────────────────── */
  {
    ...
    products: [
      { name: '热卖T恤',     title: '热卖T恤',     price: 19.99, badge: 'HOT',  rating: 4.8, reviews: 1240, desc: '爆款纯棉短袖，经典圆领，百搭不过时',    gradient: 'linear-gradient(135deg,#e8e8e8 0%,#d5d5d5 100%)' },
      { name: '百搭裤',      title: '百搭裤',      price: 24.99, badge: 'NEW',  rating: 4.7, reviews: 876,  desc: '垂感微弹，修身版型，四季可穿',           gradient: 'linear-gradient(135deg,#ebebeb 0%,#d8d8d8 100%)' },
      { name: '条纹衬衫',    title: '条纹衬衫',    price: 29.99, originalPrice: 39.99, badge: 'SALE', rating: 4.9, reviews: 532, desc: '经典条纹，通勤休闲两用', gradient: 'linear-gradient(135deg,#e5e5e5 0%,#d0d0d0 100%)' },
      { name: '运动套装',    title: '运动套装',    price: 44.99, badge: 'HOT',  rating: 4.8, reviews: 743,  desc: '速干面料，上衣+裤子套装，健身必备',       gradient: 'linear-gradient(135deg,#e0e0e0 0%,#cccccc 100%)' },
      { name: '针织开衫',    title: '针织开衫',    price: 34.99, badge: null,   rating: 4.6, reviews: 421,  desc: '软糯手感，复古色系，秋冬显白款',         gradient: 'linear-gradient(135deg,#eaeaea 0%,#d6d6d6 100%)' },
      { name: '牛仔外套',    title: '牛仔外套',    price: 49.99, badge: 'NEW',  rating: 4.7, reviews: 289,  desc: '水洗做旧，经典剪裁，搭配神器',           gradient: 'linear-gradient(135deg,#e3e3e3 0%,#d0d0d0 100%)' },
      { name: '休闲短裤',    title: '休闲短裤',    price: 18.99, originalPrice: 25.99, badge: 'SALE', rating: 4.5, reviews: 654, desc: '棉麻混纺，轻薄透气，夏日必备', gradient: 'linear-gradient(135deg,#eee 0%,#ddd 100%)' },
      { name: '卫衣',        title: '卫衣',        price: 39.99, badge: 'HOT',  rating: 4.9, reviews: 1089, desc: '450g重磅，立领设计，冬季保暖爆款',       gradient: 'linear-gradient(135deg,#e5e5e5 0%,#d0d0d0 100%)' },
    ],
  },
