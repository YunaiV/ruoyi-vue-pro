CREATE TABLE IF NOT EXISTS `product_sku` (
    ...
    `source_sku_id` varchar(128) DEFAULT NULL COMMENT '源 SKU 编号',
    `source_sku_name` varchar(255) DEFAULT NULL COMMENT '源 SKU 规格名称',
    `source_sku_url` varchar(512) DEFAULT NULL COMMENT '源 SKU 链接',
    `source_price` int DEFAULT NULL COMMENT '源采购价，单位：分',
...
CREATE TABLE IF NOT EXISTS `product_spu` (
    ...
    `source_link` varchar(512) DEFAULT NULL COMMENT '源商品链接',
    `source_platform` varchar(32) DEFAULT NULL COMMENT '来源平台',
    `source_product_id` varchar(128) DEFAULT NULL COMMENT '源商品编号',
    `source_shop_name` varchar(255) DEFAULT NULL COMMENT '源店铺名称',
    "creator" varchar(64) DEFAULT '',
    "create_time" timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updater" varchar(64) DEFAULT '',
    "update_time" timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
