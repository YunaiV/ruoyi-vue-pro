...
public interface OmsShopProductItemMapper extends BaseMapperX<OmsShopProductItemDO> {
    ...
    default MPJLambdaWrapperX<OmsShopProductItemDO> bindQueryWrapper(OmsShopProductItemPageReqVO reqVO) {
        return (MPJLambdaWrapperX<OmsShopProductItemDO>) new MPJLambdaWrapperX<OmsShopProductItemDO>()
            ...
            .leftJoin(OmsShopProductDO.class, OmsShopProductDO::getId, OmsShopProductItemDO::getShopProductId)
            .in(OmsShopProductDO::getCode, reqVO.getShopProductCodes())
    ...
    default List<OmsShopProductItemDO> getShopProductItemsByProductId(Long shopProductId) {
        return selectList(new LambdaQueryWrapperX<OmsShopProductItemDO>().eqIfPresent(OmsShopProductItemDO::getShopProductId, shopProductId));
    }

    default List<OmsShopProductItemDO> getShopProductItemsByShopProductCodes(List<String> shopProductCodes) {
        return selectList(bindQueryWrapper(OmsShopProductItemPageReqVO.builder().shopProductCodes(shopProductCodes).build()));
    }
