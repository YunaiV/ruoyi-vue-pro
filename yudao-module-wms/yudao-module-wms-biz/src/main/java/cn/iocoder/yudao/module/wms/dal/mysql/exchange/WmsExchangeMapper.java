...
public interface WmsExchangeMapper extends BaseMapperX<WmsExchangeDO> {
    ...
    /**
     * 按 code 查询唯一的 WmsExchangeDO
     */
    default WmsExchangeDO getByCode(String code) {
        LambdaQueryWrapperX<WmsExchangeDO> wrapper = new LambdaQueryWrapperX<>();
        wrapper.eq(WmsExchangeDO::getCode, code);
