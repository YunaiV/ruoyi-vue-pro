...
public class WmsWarehouseZonePageReqVO extends PageParam {
    ...
    @Schema(description = "归属的仓库ID", example = "17379")
    private Long warehouseId;

    @Schema(description = "存货类型 ; WarehouseAreaStockType : 1-拣货 , 2-存储", example = "2")
