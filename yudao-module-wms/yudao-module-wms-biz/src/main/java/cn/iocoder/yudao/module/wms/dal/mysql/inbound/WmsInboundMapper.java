...
public interface WmsInboundMapper extends BaseMapperX<WmsInboundDO> {
    ...
    default PageResult<WmsInboundDO> selectPage(WmsInboundPageReqVO reqVO) {
        return selectPage(reqVO, new LambdaQueryWrapperX<WmsInboundDO>()
				...
				.eqIfPresent(WmsInboundDO::getSourceBillType, reqVO.getSourceBillType()).// .betweenIfPresent(WmsInboundDO::getArrivalPlanTime, reqVO.getArrivalPlanTime())
        eqIfPresent(// .betweenIfPresent(WmsInboundDO::getArrivalPlanTime, reqVO.getArrivalPlanTime())
        WmsInboundDO::getTraceNo, // .betweenIfPresent(WmsInboundDO::getArrivalPlanTime, reqVO.getArrivalPlanTime())
        reqVO.getTraceNo()).// .betweenIfPresent(WmsInboundDO::getArrivalActualTime, reqVO.getArrivalActualTime())
