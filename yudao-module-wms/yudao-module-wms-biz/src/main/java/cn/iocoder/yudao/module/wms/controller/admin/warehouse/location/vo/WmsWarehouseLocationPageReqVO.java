...
/**
 * @table-fields : code,create_time,picking_order,name,area_id,warehouse_id,status
 */
@Schema(description = "管理后台 - 库位分页 Request VO")
@Data
@EqualsAndHashCode(callSuper = true)
@ToString(callSuper = true)
public class WmsWarehouseLocationPageReqVO extends PageParam {
    ...
    @Schema(description = "归属的仓库ID", example = "32537")
    private Long warehouseId;

    @Schema(description = "库区ID", example = "23286")
    private Long areaId;
