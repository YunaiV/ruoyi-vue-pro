...
/**
 * @author jisencai
 * @table-fields : tenant_id,creator,create_time,from_company_id,remark,updater,logic_move_id,update_time,from_dept_id,product_id,qty,id,to_company_id,to_dept_id
 */
@Schema(description = "管理后台 - 逻辑库存移动详情 Response VO")
@Data
@ExcelIgnoreUnannotated
public class WmsStockLogicMoveItemRespVO {
