...
public class GetProductResponse {
    ...
    private GetProductResponseData data;
     ...
     * @throws IOException if the JSON Element is invalid with respect to GetProductResponse
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!GetProductResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(String.format("The required field(s) %s in GetProductResponse is not found in the empty JSON string", GetProductResponse.openapiRequiredFields.toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!GetProductResponse.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetProductResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
            }
        }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
        // validate the optional field `data`
        if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
            GetProductResponseData.validateJsonElement(jsonObj.get("data"));
        }
    ...
    public GetProductResponse code(Integer code) {
        this.code = code;
        return this;
    }
    ...
    public GetProductResponse data(GetProductResponseData data) {
        this.data = data;
        return this;
    }
     ...
     **/
    @javax.annotation.Nullable
    public GetProductResponseData getData() {
        return data;
    }

    public void setData(GetProductResponseData data) {
        this.data = data;
    }

    public GetProductResponse message(String message) {
    ...
    public GetProductResponse requestId(String requestId) {
    ...
    public boolean equals(Object o) {
        ...
        GetProductResponse product202309GetProductResponse = (GetProductResponse) o;
        return Objects.equals(this.code, product202309GetProductResponse.code) &&
            Objects.equals(this.data, product202309GetProductResponse.data) &&
            Objects.equals(this.message, product202309GetProductResponse.message) &&
            Objects.equals(this.requestId, product202309GetProductResponse.requestId);
    }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>) new TypeAdapter<GetProductResponse>() {
                @Override
