...
public class GetAttributesResponse {
    ...
    private GetAttributesResponseData data;
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!GetAttributesResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(String.format("The required field(s) %s in GetAttributesResponse is not found in the empty JSON string", GetAttributesResponse.openapiRequiredFields.toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!GetAttributesResponse.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetAttributesResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
            }
        }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
        // validate the optional field `data`
        if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
            GetAttributesResponseData.validateJsonElement(jsonObj.get("data"));
        }
    ...
    public GetAttributesResponse code(Integer code) {
        this.code = code;
        return this;
    }
    ...
    public GetAttributesResponse data(GetAttributesResponseData data) {
        this.data = data;
        return this;
    }
     ...
     **/
    @javax.annotation.Nullable
    public GetAttributesResponseData getData() {
        return data;
    }

    public void setData(GetAttributesResponseData data) {
        this.data = data;
    }

    public GetAttributesResponse message(String message) {
    ...
    public GetAttributesResponse requestId(String requestId) {
    ...
    public boolean equals(Object o) {
        ...
        GetAttributesResponse product202309GetAttributesResponse = (GetAttributesResponse) o;
        return Objects.equals(this.code, product202309GetAttributesResponse.code) &&
            Objects.equals(this.data, product202309GetAttributesResponse.data) &&
            Objects.equals(this.message, product202309GetAttributesResponse.message) &&
            Objects.equals(this.requestId, product202309GetAttributesResponse.requestId);
    }
