...
public class GetProductResponseDataCertificationsImages {
    ...
    public GetProductResponseDataCertificationsImages addThumbUrlsItem(String thumbUrlsItem) {
    ...
    public GetProductResponseDataCertificationsImages addUrlsItem(String urlsItem) {
        if (this.urls == null) {
    ...
    public boolean equals(Object o) {
        ...
        GetProductResponseDataCertificationsImages product202309GetProductResponseDataCertificationsImages = (GetProductResponseDataCertificationsImages) o;
        return Objects.equals(this.height, product202309GetProductResponseDataCertificationsImages.height) &&
    ...
    public String toString() {
        ...
        sb.append("class GetProductResponseDataCertificationsImages {\n");
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetProductResponseDataCertificationsImages.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetProductResponseDataCertificationsImages' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<GetProductResponseDataCertificationsImages> thisAdapter
                = gson.getDelegateAdapter(this, TypeToken.get(GetProductResponseDataCertificationsImages.class));

            return (TypeAdapter<T>) new TypeAdapter<GetProductResponseDataCertificationsImages>() {
                @Override
