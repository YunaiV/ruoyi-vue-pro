...
public class CreateProductRequestBody {
    ...
    private List<CreateProductRequestBodyCertifications> certifications = new ArrayList<>();
    ...
    private List<CreateProductRequestBodyMainImages> mainImages = new ArrayList<>();
    ...
    private CreateProductRequestBodyPackageDimensions packageDimensions;
    @SerializedName(SERIALIZED_NAME_PACKAGE_WEIGHT)
    private CreateProductRequestBodyPackageWeight packageWeight;
    ...
    private List<CreateProductRequestBodyProductAttributes> productAttributes = new ArrayList<>();
    ...
    private CreateProductRequestBodySizeChart sizeChart;
    @SerializedName(SERIALIZED_NAME_SKUS)
    private List<CreateProductRequestBodySkus> skus = new ArrayList<>();
    @SerializedName(SERIALIZED_NAME_TITLE)
    private String title;
    @SerializedName(SERIALIZED_NAME_VIDEO)
    private CreateProductRequestBodyVideo video;
     ...
     * @throws IOException if the JSON Element is invalid with respect to CreateProductRequestBody
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!CreateProductRequestBody.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(String.format("The required field(s) %s in CreateProductRequestBody is not found in the empty JSON string", CreateProductRequestBody.openapiRequiredFields.toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!CreateProductRequestBody.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateProductRequestBody` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
            }
        }
        ...
        if (jsonObj.get("certifications") != null && !jsonObj.get("certifications").isJsonNull()) {
            ...
            if (jsonArraycertifications != null) {
                ...
                for (int i = 0; i < jsonArraycertifications.size(); i++) {
                    CreateProductRequestBodyCertifications.validateJsonElement(jsonArraycertifications.get(i));
                }
                ;
            }
        }
        ...
        if (jsonObj.get("main_images") != null && !jsonObj.get("main_images").isJsonNull()) {
            ...
            if (jsonArraymainImages != null) {
                ...
                for (int i = 0; i < jsonArraymainImages.size(); i++) {
                    CreateProductRequestBodyMainImages.validateJsonElement(jsonArraymainImages.get(i));
                }
                ;
            }
        }
        ...
        if (jsonObj.get("package_dimensions") != null && !jsonObj.get("package_dimensions").isJsonNull()) {
            CreateProductRequestBodyPackageDimensions.validateJsonElement(jsonObj.get("package_dimensions"));
        }
        // validate the optional field `package_weight`
        if (jsonObj.get("package_weight") != null && !jsonObj.get("package_weight").isJsonNull()) {
            CreateProductRequestBodyPackageWeight.validateJsonElement(jsonObj.get("package_weight"));
        }
        ...
        if (jsonObj.get("product_attributes") != null && !jsonObj.get("product_attributes").isJsonNull()) {
            ...
            if (jsonArrayproductAttributes != null) {
                ...
                for (int i = 0; i < jsonArrayproductAttributes.size(); i++) {
                    CreateProductRequestBodyProductAttributes.validateJsonElement(jsonArrayproductAttributes.get(i));
                }
                ;
            }
        }
        ...
        if (jsonObj.get("size_chart") != null && !jsonObj.get("size_chart").isJsonNull()) {
            CreateProductRequestBodySizeChart.validateJsonElement(jsonObj.get("size_chart"));
        }
        if (jsonObj.get("skus") != null && !jsonObj.get("skus").isJsonNull()) {
            ...
            if (jsonArrayskus != null) {
                ...
                for (int i = 0; i < jsonArrayskus.size(); i++) {
                    CreateProductRequestBodySkus.validateJsonElement(jsonArrayskus.get(i));
                }
                ;
            }
        }
        ...
        if (jsonObj.get("video") != null && !jsonObj.get("video").isJsonNull()) {
            CreateProductRequestBodyVideo.validateJsonElement(jsonObj.get("video"));
        }
    }

    /**
     * Create an instance of CreateProductRequestBody given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of CreateProductRequestBody
     * @throws IOException if the JSON string is invalid with respect to CreateProductRequestBody
     */
    public static CreateProductRequestBody fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, CreateProductRequestBody.class);
    }

    public CreateProductRequestBody brandId(String brandId) {
    ...
    public CreateProductRequestBody categoryId(String categoryId) {
    ...
    public CreateProductRequestBody categoryVersion(String categoryVersion) {
    ...
    public CreateProductRequestBody certifications(List<CreateProductRequestBodyCertifications> certifications) {
        this.certifications = certifications;
        return this;
    }

    public CreateProductRequestBody addCertificationsItem(CreateProductRequestBodyCertifications certificationsItem) {
     ...
     **/
    @javax.annotation.Nullable
    public List<CreateProductRequestBodyCertifications> getCertifications() {
        return certifications;
    }

    public void setCertifications(List<CreateProductRequestBodyCertifications> certifications) {
        this.certifications = certifications;
    }

    public CreateProductRequestBody deliveryOptionIds(List<String> deliveryOptionIds) {
        this.deliveryOptionIds = deliveryOptionIds;
        return this;
    }

    public CreateProductRequestBody addDeliveryOptionIdsItem(String deliveryOptionIdsItem) {
    ...
    public CreateProductRequestBody description(String description) {
    ...
    public CreateProductRequestBody externalProductId(String externalProductId) {
    ...
    public CreateProductRequestBody idempotencyKey(String idempotencyKey) {
    ...
    public CreateProductRequestBody isCodAllowed(Boolean isCodAllowed) {
    ...
    public CreateProductRequestBody isNotForSale(Boolean isNotForSale) {
    ...
    public CreateProductRequestBody isPreOwned(Boolean isPreOwned) {
    ...
    public CreateProductRequestBody listingPlatforms(List<String> listingPlatforms) {
        this.listingPlatforms = listingPlatforms;
        return this;
    }

    public CreateProductRequestBody addListingPlatformsItem(String listingPlatformsItem) {
    ...
    public CreateProductRequestBody mainImages(List<CreateProductRequestBodyMainImages> mainImages) {
        this.mainImages = mainImages;
        return this;
    }

    public CreateProductRequestBody addMainImagesItem(CreateProductRequestBodyMainImages mainImagesItem) {
     ...
     **/
    @javax.annotation.Nullable
    public List<CreateProductRequestBodyMainImages> getMainImages() {
        return mainImages;
    }

    public void setMainImages(List<CreateProductRequestBodyMainImages> mainImages) {
        this.mainImages = mainImages;
    }

    public CreateProductRequestBody manufacturerIds(List<String> manufacturerIds) {
        this.manufacturerIds = manufacturerIds;
        return this;
    }

    public CreateProductRequestBody addManufacturerIdsItem(String manufacturerIdsItem) {
    ...
    public CreateProductRequestBody minimumOrderQuantity(Integer minimumOrderQuantity) {
    ...
    public CreateProductRequestBody packageDimensions(CreateProductRequestBodyPackageDimensions packageDimensions) {
     ...
     **/
    @javax.annotation.Nullable
    public CreateProductRequestBodyPackageDimensions getPackageDimensions() {
        return packageDimensions;
    }

    public void setPackageDimensions(CreateProductRequestBodyPackageDimensions packageDimensions) {
        this.packageDimensions = packageDimensions;
    }

    public CreateProductRequestBody packageWeight(CreateProductRequestBodyPackageWeight packageWeight) {
     ...
     **/
    @javax.annotation.Nullable
    public CreateProductRequestBodyPackageWeight getPackageWeight() {
        return packageWeight;
    }

    public void setPackageWeight(CreateProductRequestBodyPackageWeight packageWeight) {
        this.packageWeight = packageWeight;
    }

    public CreateProductRequestBody primaryCombinedProductId(String primaryCombinedProductId) {
    ...
    public CreateProductRequestBody productAttributes(List<CreateProductRequestBodyProductAttributes> productAttributes) {
        this.productAttributes = productAttributes;
        return this;
    }

    public CreateProductRequestBody addProductAttributesItem(CreateProductRequestBodyProductAttributes productAttributesItem) {
     ...
     **/
    @javax.annotation.Nullable
    public List<CreateProductRequestBodyProductAttributes> getProductAttributes() {
        return productAttributes;
    }

    public void setProductAttributes(List<CreateProductRequestBodyProductAttributes> productAttributes) {
        this.productAttributes = productAttributes;
    }

    public CreateProductRequestBody responsiblePersonIds(List<String> responsiblePersonIds) {
        this.responsiblePersonIds = responsiblePersonIds;
        return this;
    }

    public CreateProductRequestBody addResponsiblePersonIdsItem(String responsiblePersonIdsItem) {
    ...
    public CreateProductRequestBody saveMode(String saveMode) {
    ...
    public CreateProductRequestBody shippingInsuranceRequirement(String shippingInsuranceRequirement) {
    ...
    public CreateProductRequestBody sizeChart(CreateProductRequestBodySizeChart sizeChart) {
     ...
     **/
    @javax.annotation.Nullable
    public CreateProductRequestBodySizeChart getSizeChart() {
        return sizeChart;
    }

    public void setSizeChart(CreateProductRequestBodySizeChart sizeChart) {
        this.sizeChart = sizeChart;
    }

    public CreateProductRequestBody skus(List<CreateProductRequestBodySkus> skus) {
        this.skus = skus;
        return this;
    }

    public CreateProductRequestBody addSkusItem(CreateProductRequestBodySkus skusItem) {
        if (this.skus == null) {
     ...
     **/
    @javax.annotation.Nullable
    public List<CreateProductRequestBodySkus> getSkus() {
        return skus;
    }

    public void setSkus(List<CreateProductRequestBodySkus> skus) {
        this.skus = skus;
    }

    public CreateProductRequestBody title(String title) {
        this.title = title;
        return this;
    }
    ...
    public CreateProductRequestBody video(CreateProductRequestBodyVideo video) {
        this.video = video;
        return this;
    }
     ...
     **/
    @javax.annotation.Nullable
    public CreateProductRequestBodyVideo getVideo() {
        return video;
    }

    public void setVideo(CreateProductRequestBodyVideo video) {
        this.video = video;
    }
    ...
    public boolean equals(Object o) {
        ...
        CreateProductRequestBody product202309CreateProductRequestBody = (CreateProductRequestBody) o;
        return Objects.equals(this.brandId, product202309CreateProductRequestBody.brandId) &&
            Objects.equals(this.categoryId, product202309CreateProductRequestBody.categoryId) &&
            Objects.equals(this.categoryVersion, product202309CreateProductRequestBody.categoryVersion) &&
            Objects.equals(this.certifications, product202309CreateProductRequestBody.certifications) &&
            Objects.equals(this.deliveryOptionIds, product202309CreateProductRequestBody.deliveryOptionIds) &&
            Objects.equals(this.description, product202309CreateProductRequestBody.description) &&
            Objects.equals(this.externalProductId, product202309CreateProductRequestBody.externalProductId) &&
            Objects.equals(this.idempotencyKey, product202309CreateProductRequestBody.idempotencyKey) &&
            Objects.equals(this.isCodAllowed, product202309CreateProductRequestBody.isCodAllowed) &&
            Objects.equals(this.isNotForSale, product202309CreateProductRequestBody.isNotForSale) &&
            Objects.equals(this.isPreOwned, product202309CreateProductRequestBody.isPreOwned) &&
            Objects.equals(this.listingPlatforms, product202309CreateProductRequestBody.listingPlatforms) &&
            Objects.equals(this.mainImages, product202309CreateProductRequestBody.mainImages) &&
            Objects.equals(this.manufacturerIds, product202309CreateProductRequestBody.manufacturerIds) &&
            Objects.equals(this.minimumOrderQuantity, product202309CreateProductRequestBody.minimumOrderQuantity) &&
            Objects.equals(this.packageDimensions, product202309CreateProductRequestBody.packageDimensions) &&
            Objects.equals(this.packageWeight, product202309CreateProductRequestBody.packageWeight) &&
            Objects.equals(this.primaryCombinedProductId, product202309CreateProductRequestBody.primaryCombinedProductId) &&
            Objects.equals(this.productAttributes, product202309CreateProductRequestBody.productAttributes) &&
            Objects.equals(this.responsiblePersonIds, product202309CreateProductRequestBody.responsiblePersonIds) &&
            Objects.equals(this.saveMode, product202309CreateProductRequestBody.saveMode) &&
            Objects.equals(this.shippingInsuranceRequirement, product202309CreateProductRequestBody.shippingInsuranceRequirement) &&
            Objects.equals(this.sizeChart, product202309CreateProductRequestBody.sizeChart) &&
            Objects.equals(this.skus, product202309CreateProductRequestBody.skus) &&
            Objects.equals(this.title, product202309CreateProductRequestBody.title) &&
            Objects.equals(this.video, product202309CreateProductRequestBody.video);
    }

    @Override
    public int hashCode() {
        return Objects.hash(brandId, categoryId, categoryVersion, certifications, deliveryOptionIds, description, externalProductId, idempotencyKey, isCodAllowed, isNotForSale, isPreOwned, listingPlatforms, mainImages, manufacturerIds, minimumOrderQuantity, packageDimensions, packageWeight, primaryCombinedProductId, productAttributes, responsiblePersonIds, saveMode, shippingInsuranceRequirement, sizeChart, skus, title, video);
    }
    ...
    /**
     * Convert an instance of CreateProductRequestBody to an JSON string
     *
     * @return JSON string
     */
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!CreateProductRequestBody.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'CreateProductRequestBody' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<CreateProductRequestBody> thisAdapter
                = gson.getDelegateAdapter(this, TypeToken.get(CreateProductRequestBody.class));

            return (TypeAdapter<T>) new TypeAdapter<CreateProductRequestBody>() {
                @Override
                public void write(JsonWriter out, CreateProductRequestBody value) throws IOException {
                    JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
                    elementAdapter.write(out, obj);
                }

                @Override
                public CreateProductRequestBody read(JsonReader in) throws IOException {
