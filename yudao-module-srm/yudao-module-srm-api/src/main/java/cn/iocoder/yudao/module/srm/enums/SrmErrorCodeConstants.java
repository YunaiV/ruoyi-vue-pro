...
public interface SrmErrorCodeConstants {
    ...
    ErrorCode PURCHASE_ORDER_ITEM_IN_FAIL_PRODUCT_EXCEED =
        new ErrorCode(1_030_101_007, "采购订单项({})超过最大允许入库数量({})");
    ErrorCode PURCHASE_ORDER_PROCESS_FAIL_EXISTS_IN = new ErrorCode(1_030_101_008, "反审核失败，已存在对应的采购入库单");
    ErrorCode PURCHASE_ORDER_ITEM_RETURN_FAIL_IN_EXCEED =
        new ErrorCode(1_030_101_009, "采购订单项({})超过最大允许退货数量({})");
    ErrorCode PURCHASE_ORDER_PROCESS_FAIL_EXISTS_RETURN =
        new ErrorCode(1_030_101_010, "反审核失败，已存在对应的采购退货单");
    ...
    ErrorCode PURCHASE_ORDER_ITEM_PURCHASE_FAIL_EXCEED =
        new ErrorCode(1_030_101_015, "采购数量不能大于申请项({})的剩余订购数量({})");
    ...
    ErrorCode PURCHASE_ORDER_ITEM_NOT_AUDIT =
        new ErrorCode(1_030_101_020, "采购订单项({})的订单不是已审核状态，无法合并入库");
    ...
    ErrorCode PURCHASE_IN_FAIL_PAYMENT_PRICE_EXCEED =
        new ErrorCode(1_030_102_007, "付款金额({})超过采购入库单总金额({})");
    ...
    ErrorCode PURCHASE_IN_PROCESS_FAIL_PAYMENT_STATUS =
        new ErrorCode(1_030_102_010, "反审核失败，已付款入库单不能反审核");
    ErrorCode PURCHASE_IN_ITEM_NOT_EXISTS = new ErrorCode(1_030_102_011, "采购入库单项({})不存在");
    ErrorCode PURCHASE_IN_ITEM_NOT_AUDIT =
        new ErrorCode(1_030_102_012, "采购入库单项({})关联的入库单未审核，无法创建退货单");
    //PURCHASE_IN_PROCESS_FAIL_RETURN_ITEM_EXISTS
    ErrorCode PURCHASE_IN_PROCESS_FAIL_RETURN_ITEM_EXISTS =
        new ErrorCode(1_030_102_013, "反审核失败，入库项{}已存在对应的退货单");
    //存在退货单，不能删除
    ...
    ErrorCode PURCHASE_RETURN_FAIL_REFUND_PRICE_EXCEED =
        new ErrorCode(1_030_103_007, "退款金额({})超过采购退货单总金额({})");
    ErrorCode PURCHASE_RETURN_PROCESS_FAIL_EXISTS_REFUND =
        new ErrorCode(1_030_103_008, "反审核失败，已存在对应的退款单");
    ...
    ErrorCode PURCHASE_REQUEST_ITEM_NOT_FOUND =
        new ErrorCode(1_030_603_102, "未找到对应的采购申请项,订单项id={},申请项id={}");
    ...
    ErrorCode PURCHASE_REQUEST_UPDATE_FAIL_REQUEST_ID =
        new ErrorCode(1_030_603_123, "申请单子表id为({})不属于该采购申请单");
    ...
    ErrorCode PURCHASE_REQUEST_PROCESS_FAIL =
        new ErrorCode(1_030_603_132, "反审核失败，只有已审核的采购申请单才能反审核");
    ErrorCode PURCHASE_REQUEST_PROCESS_FAIL_CLOSE =
        new ErrorCode(1_030_603_133, "反审核失败，已关闭的采购申请单不能反审核");
    ErrorCode PURCHASE_REQUEST_PROCESS_FAIL_ORDERED =
        new ErrorCode(1_030_603_134, "反审核失败，已订购的采购申请单不能反审核");
    ...
    //存在对应订单，无法手动关闭
    ErrorCode PURCHASE_REQUEST_ITEM_NOT_EXISTS_BY_MANUAL_CLOSE =
        new ErrorCode(1_030_603_147, "申请单存在关联订单,无法手动关闭状态");
    ...
    ErrorCode NO_REPEAT_OF_COUNTRY_CODE_AND_SUPPLIER_PRODUCT_CODE =
        new ErrorCode(1_030_608_002, "海关规则中，国家代码+供应商产品编码不能重复");
    ErrorCode NO_REPEAT_OF_COUNTRY_CODE_AND_PRODUCT_CODE =
        new ErrorCode(1_030_608_003, "海关规则中，产品编码+国家代码({})不能重复");
    ...
    ErrorCode CUSTOM_RULE_CATEGORY_ITEM_NOT_EXISTS_BY_PRODUCT_ID =
        new ErrorCode(1_030_610_001, "所选产品中不存在海关分类数据");
