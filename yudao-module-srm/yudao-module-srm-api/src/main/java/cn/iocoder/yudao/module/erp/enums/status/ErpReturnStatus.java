...
@Getter
public enum ErpReturnStatus implements ArrayValuable<Integer> {
    //未退款
    NOT_RETURN(0, "未退款"),
    //已退款
    RETURNED(1, "已退款"),
    ...
    public static final int[] ARRAYS = Arrays.stream(values()).mapToInt(ErpReturnStatus::getCode).toArray();
    private static final Map<Integer, ErpReturnStatus> STATUS_MAP = new HashMap<>();
    // 存储状态码和描述的字段
