...
@Component
@Slf4j
public class ActionOrderItemPayImpl implements Action<ErpPaymentStatus, SrmEventEnum, ErpPurchaseOrderItemDO> {
    @Resource
    ...
    public void execute(ErpPaymentStatus f, ErpPaymentStatus t, SrmEventEnum srmEventEnum,
...
//        paymentStateMachine.fireEvent(ErpPaymentStatus.fromCode(orderDO.getPayStatus()), srmEventEnum, orderDO);
    }
}
