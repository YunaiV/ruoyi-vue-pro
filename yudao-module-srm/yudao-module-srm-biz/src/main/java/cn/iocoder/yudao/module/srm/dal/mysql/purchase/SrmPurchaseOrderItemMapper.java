...
public interface SrmPurchaseOrderItemMapper extends BaseMapperX<SrmPurchaseOrderItemDO> {
    ...
    default MPJLambdaWrapper<SrmPurchaseOrderItemDO> getBOWrapper(SrmPurchaseOrderPageReqVO reqVO) {
        return wrapper(reqVO).leftJoin(SrmPurchaseOrderDO.class, SrmPurchaseOrderDO::getId, SrmPurchaseOrderItemDO::getOrderId)
            ...
            .eqIfExists(SrmPurchaseOrderDO::getTotalCount, reqVO.getTotalCount()).eqIfExists(SrmPurchaseOrderDO::getTotalPrice, reqVO.getTotalPrice())
            ...
            .eqIfExists(SrmPurchaseOrderDO::getDiscountPrice, reqVO.getDiscountPrice()).eqIfExists(SrmPurchaseOrderDO::getDepositPrice, reqVO.getDepositPrice())
            .eqIfExists(SrmPurchaseOrderDO::getFileUrl, reqVO.getFileUrl()).eqIfExists(SrmPurchaseOrderDO::getRemark, reqVO.getRemark())
            ...
            .likeIfExists(SrmPurchaseOrderDO::getContainerRate, reqVO.getContainerRate()).eqIfExists(SrmPurchaseOrderDO::getWarehouseId, reqVO.getWarehouseId())
    ...
    default PageResult<SrmPurchaseOrderItemBO> selectErpPurchaseOrderItemBOPage(SrmPurchaseOrderPageReqVO reqVO) {
        MPJLambdaWrapper<SrmPurchaseOrderItemDO> wrapper =
            getBOWrapper(reqVO).selectAssociation(SrmPurchaseOrderDO.class, SrmPurchaseOrderItemBO::getSrmPurchaseOrderDO);//一对一关联
    ...
    default SrmPurchaseOrderItemBO selectErpPurchaseOrderItemBOById(Long id) {
        MPJLambdaWrapper<SrmPurchaseOrderItemDO> wrapper =
            getBOWrapper(null).selectAssociation(SrmPurchaseOrderDO.class, SrmPurchaseOrderItemBO::getSrmPurchaseOrderDO)//一对一关联
