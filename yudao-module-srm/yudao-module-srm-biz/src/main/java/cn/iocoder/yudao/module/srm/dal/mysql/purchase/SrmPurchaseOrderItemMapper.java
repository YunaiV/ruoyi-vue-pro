...
//            .betweenIfPresent(SrmPurchaseOrderDO::getAuditTime, reqVO.getAuditTime())
            .eqIfExists(SrmPurchaseOrderDO::getPurchaseEntityId, reqVO.getPurchaseEntityId())
            .eqIfExists(SrmPurchaseOrderDO::getInspectionJson, reqVO.getInspectionJson())
            .eqIfExists(SrmPurchaseOrderDO::getCompletionJson, reqVO.getCompletionJson())
            ...
            .eqIfExists(SrmPurchaseOrderDO::getTotalInspectionPassCount, reqVO.getTotalInspectionPassCount())
            ;
    }
    ...
    default PageResult<SrmPurchaseOrderItemBO> selectErpPurchaseOrderItemBOPage(SrmPurchaseOrderPageReqVO reqVO) {
        MPJLambdaWrapper<SrmPurchaseOrderItemDO> wrapper = getBOWrapper(reqVO)
            .selectAssociation(SrmPurchaseOrderDO.class, SrmPurchaseOrderItemBO::getSrmPurchaseOrderDO);//一对一关联
    ...
    default SrmPurchaseOrderItemBO selectErpPurchaseOrderItemBOById(Long id) {
        MPJLambdaWrapper<SrmPurchaseOrderItemDO> wrapper = getBOWrapper(null)
            .selectAssociation(SrmPurchaseOrderDO.class, SrmPurchaseOrderItemBO::getSrmPurchaseOrderDO)//一对一关联
    ...
    default Collection<SrmPurchaseOrderItemDO> selectIdsByErpPurchaseRequestItemNo(String erpPurchaseRequestItemNo) {
        MPJLambdaWrapper<SrmPurchaseOrderItemDO> wrapper = new MPJLambdaWrapperX<SrmPurchaseOrderItemDO>()
            .selectAll(SrmPurchaseOrderItemDO.class)
