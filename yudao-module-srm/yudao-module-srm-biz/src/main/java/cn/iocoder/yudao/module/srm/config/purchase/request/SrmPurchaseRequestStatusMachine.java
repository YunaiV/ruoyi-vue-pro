...
import cn.iocoder.yudao.module.srm.config.purchase.request.impl.action.StoragActionImpl;
...
public class SrmPurchaseRequestStatusMachine {
    @Resource
    private Condition<SrmPurchaseRequestDO> baseConditionImpl;

    @Resource
    private Action<SrmAuditStatus, SrmEventEnum, SrmPurchaseRequestAuditReqVO> actionAuditImpl;
    @Resource
    private Action<SrmOffStatus, SrmEventEnum, SrmPurchaseRequestDO> actionOffImpl;
    @Resource
    private Action<SrmOrderStatus, SrmEventEnum, SrmPurchaseRequestDO> actionOrderImpl;
    @Resource
    ...
    public StateMachine<SrmOffStatus, SrmEventEnum, SrmPurchaseRequestDO> getPurchaseRequestOffStateMachine() {
        ...
        // 开启
        builder.externalTransitions()
            .fromAmong(SrmOffStatus.CLOSED, SrmOffStatus.MANUAL_CLOSED)
    ...
    @Resource
    StoragActionImpl storagActionImpl;
