...
@Slf4j
@Component
public class ActionItemOffImpl implements Action<ErpOffStatus, SrmEventEnum, ErpPurchaseRequestItemsDO> {
    ...
    private StateMachine<ErpOffStatus, SrmEventEnum, ErpPurchaseRequestDO> machine;

    @Override
    @Transactional
    public void execute(ErpOffStatus from, ErpOffStatus to, SrmEventEnum event, ErpPurchaseRequestItemsDO context) {
        // 查询当前 Item
