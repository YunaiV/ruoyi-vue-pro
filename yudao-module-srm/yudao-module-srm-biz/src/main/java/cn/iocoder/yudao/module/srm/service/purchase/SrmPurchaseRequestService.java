 ...
 * @author 索迈管理员
 */
public interface SrmPurchaseRequestService {
     ...
     * @return 编号
     */
    Long createPurchaseRequest(@Valid SrmPurchaseRequestSaveReqVO createReqVO);
     ...
     */
    void updatePurchaseRequest(@Valid SrmPurchaseRequestSaveReqVO updateReqVO);
     ...
     * @return 一主 + 多从DO
     */
    PageResult<SrmPurchaseRequestBO> getPurchaseRequestItemBOPage(SrmPurchaseRequestPageReqVO pageReqVO);
    /**
     * 获得采购申请单单项列表
     *
     ...
     * @return 采购订单项 List
     */
    List<SrmPurchaseRequestItemsDO> getPurchaseRequestItemListByOrderIds(Collection<Long> requestIds);
     ...
     */
    void reviewPurchaseOrder(SrmPurchaseRequestAuditReqVO req);
     ...
     * @return 采购订单
     */
    SrmPurchaseRequestDO validateIdExists(Long id);

    /**
     * 校验采购订单的子项目是否合法
     */
    SrmPurchaseRequestItemsDO validItemIdExist(Long id);
