...
public class ImGroupMemberServiceImplTest extends BaseMockitoUnitTest {
    ...
    public void testAddGroupMembers_mixedInsertAndUpdate() {
        ...
        when(groupMemberMapper.selectListByGroupIdAndUserIds(eq(10L), anyCollection()))
                .thenReturn(listOf(exist3, exist4));

        // 调用
        groupMemberService.addGroupMembers(10L, listOf(2L, 3L, 4L));
    ...
    public void testAddGroupMembers_allExisting_onlyUpdates() {
        ...
        List<ImGroupMemberDO> existing = listOf(
        ...
        groupMemberService.addGroupMembers(10L, listOf(2L, 3L));
    ...
    public void testAddGroupMembers_allExistingEnabled_nothingHappens() {
        ...
        groupMemberService.addGroupMembers(10L, listOf(2L));
    ...
    public void testUpdateGroupMember_success() {
        ...
        verify(groupMessageService).sendGroupMessage(eq(1L), eq(listOf(1L)),
    ...
    public void testRemoveGroupMembers_batch() {
        groupMemberService.removeGroupMembers(10L, listOf(2L, 3L));
    ...
    public void testGetActiveGroupMemberUserIdsByGroupId_extractsUserIds() {
        // 准备：3 个 ENABLE 成员
        List<ImGroupMemberDO> members = listOf(
        ...
        // 断言：只返回 userId、顺序保留
        assertEquals(listOf(1L, 2L, 3L), userIds);
    }

    @Test
    public void testGetActiveGroupMemberUserIdsByGroupId_emptyList() {
        when(groupMemberMapper.selectListByGroupIdAndStatus(
                10L, CommonStatusEnum.ENABLE.getStatus())).thenReturn(listOf());
    ...
    public void testGetGroupMemberListByOwnerAndAdmin_passesRoles() {
        List<Integer> roles = listOf(ImGroupMemberRoleEnum.OWNER.getRole(), ImGroupMemberRoleEnum.ADMIN.getRole());
        List<ImGroupMemberDO> members = listOf(ImGroupMemberDO.builder().groupId(10L).userId(1L).build());
