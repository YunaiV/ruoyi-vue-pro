...
public class WmsStockBinMoveTest extends BaseRestIntegrationTest {
    ...
    public void testMove() {
        ...
        // 找一个合适的目标仓位
        CommonResult<List<WmsWarehouseBinSimpleRespVO>> binSimpleList = this.wms().warehouseBinClient().getBinSimpleList(warehouseId);
        ...
        CommonResult<List<WmsStockBinRespVO>> toStockBinPageResult = this.wms().stockBinClient().getStockBin(warehouseId, toStockBin.getId(),fromStockBinVOBefore.getProductId());
        ...
        CommonResult<Long> postResult=this.wms().stockBinClient().createStockBinMove(createReqVO);
        ...
        CommonResult<List<WmsStockBinRespVO>> fromStockBinResultAfter = this.wms().stockBinClient().getStockBin(warehouseId, fromStockBinVOBefore.getBinId(), fromStockBinVOBefore.getProductId());
        CommonResult<List<WmsStockBinRespVO>> toStockBinResultAfter = this.wms().stockBinClient().getStockBin(warehouseId, toStockBinVOBefore.getBinId(), toStockBinVOBefore.getProductId());
