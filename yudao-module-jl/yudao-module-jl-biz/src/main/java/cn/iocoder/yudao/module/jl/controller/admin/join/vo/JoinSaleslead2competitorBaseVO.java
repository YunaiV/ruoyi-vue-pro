 ...
 */
@Data
public class JoinSaleslead2competitorBaseVO {

    @Schema(description = "销售线索 id", requiredMode = Schema.RequiredMode.REQUIRED, example = "13849")
    @NotNull(message = "销售线索 id不能为空")
    private Long salesleadId;

    @Schema(description = "竞争对手", requiredMode = Schema.RequiredMode.REQUIRED, example = "24554")
