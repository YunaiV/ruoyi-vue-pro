...
@Slf4j
@Component
public class ActionInAuditImpl implements Action<ErpAuditStatus, ErpEventEnum, ErpPurchaseInAuditReqVO> {
    ...
    @Override
    @Transactional
    public void execute(ErpAuditStatus from, ErpAuditStatus to, ErpEventEnum event, ErpPurchaseInAuditReqVO req) {
...
//        ThrowUtil.ifThrow(!itemsMapper.updateBatch(itemsDOS), DB_BATCH_UPDATE_ERROR);
    ...
    //校验方法
    public void validate(ErpAuditStatus from, ErpAuditStatus to, ErpEventEnum event, ErpPurchaseInDO aDo) {
//        //如果是反审核事件
//        if (event == ErpEventEnum.WITHDRAW_REVIEW) {
//            //不是开启->异常
