package cn.iocoder.yudao.module.srm.service.product.wallmountedtvcabinet;
...
import cn.iocoder.yudao.module.srm.service.product.wallmountedtvcabinet.bo.WallMountedTVCabinetBO;
 ...
 */
@Service
public class ErpProductWallMountedTVCabinetServiceImpl extends ErpProductServiceImpl implements ErpProductWallMountedTVCabinetService {
    @Override
    public ErpProductBO toBO(ErpProductSaveReqVO saveReqVO) {
        validateFields(saveReqVO);
        return BeanUtils.toBean(saveReqVO, WallMountedTVCabinetBO.class);
    }

    @Override
    public ErpProductBO toBO(ErpProductDO productDO) {
        return BeanUtils.toBean(productDO, WallMountedTVCabinetBO.class);
    }
    @Override
    public void validateFields(ErpProductSaveReqVO saveReqVO){
        ThrowUtil.ifThrow(BeanUtils.areAllNonNullFieldsPresent(saveReqVO, WallMountedTVCabinetBO.class),PRODUCT_FIELD_NOT_MATCH);
    }
}
