...
import cn.iocoder.yudao.module.srm.controller.admin.stock.vo.in.ErpStockInPageReqVO;
import cn.iocoder.yudao.module.srm.controller.admin.stock.vo.in.ErpStockInSaveReqVO;
import cn.iocoder.yudao.module.srm.dal.dataobject.product.ErpProductDO;
import cn.iocoder.yudao.module.srm.dal.dataobject.stock.ErpStockInDO;
import cn.iocoder.yudao.module.srm.dal.dataobject.stock.ErpStockInItemDO;
import cn.iocoder.yudao.module.srm.dal.mysql.stock.ErpStockInItemMapper;
import cn.iocoder.yudao.module.srm.dal.mysql.stock.ErpStockInMapper;
...
//        supplierService.validateSupplier(createReqVO.getSupplierId());
    ...
    public void updateStockIn(ErpStockInSaveReqVO updateReqVO) {
        ...
        if (ErpAuditStatus.APPROVED.getCode().equals(stockIn.getStatus())) {
