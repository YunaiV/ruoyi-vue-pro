...
import cn.iocoder.yudao.module.srm.controller.admin.sale.vo.order.ErpSaleOrderPageReqVO;
import cn.iocoder.yudao.module.srm.controller.admin.sale.vo.order.ErpSaleOrderSaveReqVO;
...
import cn.iocoder.yudao.module.srm.dal.dataobject.sale.ErpSaleOrderItemDO;
import cn.iocoder.yudao.module.srm.dal.mysql.sale.ErpSaleOrderItemMapper;
import cn.iocoder.yudao.module.srm.dal.mysql.sale.ErpSaleOrderMapper;
...
public class ErpSaleOrderServiceImpl implements ErpSaleOrderService {
    ...
    public void updateSaleOrder(ErpSaleOrderSaveReqVO updateReqVO) {
        ...
        if (ErpAuditStatus.APPROVED.getCode().equals(saleOrder.getStatus())) {
    ...
    public ErpSaleOrderDO validateSaleOrder(Long id) {
        ErpSaleOrderDO saleOrder = validateSaleOrderExists(id);
        if (ObjectUtil.notEqual(saleOrder.getStatus(), ErpAuditStatus.APPROVED.getCode())) {
