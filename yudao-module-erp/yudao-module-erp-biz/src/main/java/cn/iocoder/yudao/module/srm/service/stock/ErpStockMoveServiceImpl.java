package cn.iocoder.yudao.module.srm.service.stock;
...
import cn.iocoder.yudao.module.srm.controller.admin.stock.vo.move.ErpStockMovePageReqVO;
import cn.iocoder.yudao.module.srm.controller.admin.stock.vo.move.ErpStockMoveSaveReqVO;
import cn.iocoder.yudao.module.srm.dal.dataobject.product.ErpProductDO;
import cn.iocoder.yudao.module.srm.dal.dataobject.stock.ErpStockMoveDO;
import cn.iocoder.yudao.module.srm.dal.dataobject.stock.ErpStockMoveItemDO;
import cn.iocoder.yudao.module.srm.dal.mysql.stock.ErpStockMoveItemMapper;
import cn.iocoder.yudao.module.srm.dal.mysql.stock.ErpStockMoveMapper;
...
public class ErpStockMoveServiceImpl implements ErpStockMoveService {
    ...
    public void updateStockMove(ErpStockMoveSaveReqVO updateReqVO) {
        ...
        if (ErpAuditStatus.APPROVED.getCode().equals(stockMove.getStatus())) {
