...
import static cn.iocoder.yudao.module.erp.enums.ErpStateMachines.PURCHASE_IN_PAYMENT_STATE_MACHINE;
...
public class ActionInPayItemImpl implements Action<ErpPaymentStatus, ErpEventEnum, ErpPurchaseInItemDO> {
    ...
    private StateMachine<ErpPaymentStatus, ErpEventEnum, ErpPurchaseInDO> stateMachine;
    @Autowired
...
//        }
    ...
    private void forwardMsg(ErpPurchaseInItemDO inItemDO) {
        ...
        stateMachine.fireEvent(ErpPaymentStatus.fromCode(erpPurchaseInDO.getPayStatus()), ErpEventEnum.PAYMENT_ADJUSTMENT, erpPurchaseInDO);
    }
