...
@Slf4j
@Component
public class ActionRefundAuditImpl implements Action<ErpAuditStatus, ErpEventEnum, ErpPurchaseReturnAuditReqVO> {
    ...
    @Override
    @Transactional
    public void execute(ErpAuditStatus from, ErpAuditStatus to, ErpEventEnum event, ErpPurchaseReturnAuditReqVO req) {
