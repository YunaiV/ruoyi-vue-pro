...
public class ErpPurchaseRequestItemsSaveReqVO {
    ...
    @Schema(description = "申请单id", requiredMode = Schema.RequiredMode.REQUIRED, example = "2055")
    ...
    @Schema(description = "仓库编号", requiredMode = Schema.RequiredMode.REQUIRED, example = "101")
