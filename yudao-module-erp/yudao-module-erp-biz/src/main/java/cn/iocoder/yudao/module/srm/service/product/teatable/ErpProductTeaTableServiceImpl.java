package cn.iocoder.yudao.module.srm.service.product.teatable;
...
import cn.iocoder.yudao.module.srm.service.product.teatable.bo.TeaTableBO;
 ...
 */
@Service
public class ErpProductTeaTableServiceImpl extends ErpProductServiceImpl implements ErpProductTeaTableService {
    @Override
    public ErpProductBO toBO(ErpProductSaveReqVO saveReqVO) {
        validateFields(saveReqVO);
        return BeanUtils.toBean(saveReqVO, TeaTableBO.class);
    }

    @Override
    public ErpProductBO toBO(ErpProductDO productDO) {
        return BeanUtils.toBean(productDO, TeaTableBO.class);
    }
    @Override
    public void validateFields(ErpProductSaveReqVO saveReqVO){
        ThrowUtil.ifThrow(BeanUtils.areAllNonNullFieldsPresent(saveReqVO, TeaTableBO.class),PRODUCT_FIELD_NOT_MATCH);
    }
}
