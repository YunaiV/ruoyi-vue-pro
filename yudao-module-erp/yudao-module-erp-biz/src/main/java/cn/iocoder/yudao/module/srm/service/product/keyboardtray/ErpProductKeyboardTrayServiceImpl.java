package cn.iocoder.yudao.module.srm.service.product.keyboardtray;
...
import cn.iocoder.yudao.module.srm.service.product.keyboardtray.bo.KeyboardTrayBO;
 ...
 */
@Service
public class ErpProductKeyboardTrayServiceImpl extends ErpProductServiceImpl implements ErpProductKeyboardTrayService {
    @Override
    public ErpProductBO toBO(ErpProductSaveReqVO saveReqVO) {
        validateFields(saveReqVO);
        return BeanUtils.toBean(saveReqVO, KeyboardTrayBO.class);
    }

    @Override
    public ErpProductBO toBO(ErpProductDO productDO) {
        return BeanUtils.toBean(productDO, KeyboardTrayBO.class);
    }
    @Override
    public void validateFields(ErpProductSaveReqVO saveReqVO){
        ThrowUtil.ifThrow(BeanUtils.areAllNonNullFieldsPresent(saveReqVO, KeyboardTrayBO.class),PRODUCT_FIELD_NOT_MATCH);
    }
}
