...
public class ActionOrderItemOffImpl implements Action<ErpOffStatus, ErpEventEnum, ErpPurchaseOrderItemDO> {
     ...
     */
    @Transactional()
    public void updateOrderStatusIfNeeded(ErpPurchaseOrderDO orderDO, ErpEventEnum event, ErpOffStatus to) {
        ...
        if (aDo == null) {
            ...
            throw ServiceExceptionUtil.exception(ErrorCodeConstants.PURCHASE_ORDER_NOT_EXISTS, orderDO.getId());
        }
