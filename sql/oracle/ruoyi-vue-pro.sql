...
CREATE TABLE "SYSTEM_MENU" (
  ...
  "VISIBLE" NVARCHAR2(4 BYTE) NOT NULL,
  "KEEP_ALIVE" NVARCHAR2(4 BYTE) NOT NULL,
  "CREATOR" NVARCHAR2(64),
  "CREATE_TIME" DATE NOT NULL,
  "UPDATER" NVARCHAR2(64),
  "UPDATE_TIME" DATE NOT NULL,
...
CREATE TABLE "SYSTEM_OAUTH2_CLIENT" (
  ...
  "AUTO_APPROVE" VARCHAR2(1 BYTE) NOT NULL,
...
ALTER TABLE "SYSTEM_OAUTH2_CLIENT" ADD CONSTRAINT "SYS_C008438" CHECK ("AUTO_APPROVE" IS NOT NULL) NOT DEFERRABLE INITIALLY IMMEDIATE NORELY VALIDATE;
