...
INSERT INTO system_menu (id, name, permission, type, sort, parent_id, path, icon, component, component_name, status, visible, keep_alive, always_show, creator, create_time, updater, update_time, deleted) VALUES (117, 'apiKey管理', '', 2, 3, 1261, 'apikey', 'fa:key', 'system/oauth2/apikey/index', 'SystemApiKeyClient', 0, '1', '1', '1', 'admin', to_date('2024-12-05 18:03:48', 'SYYYY-MM-DD HH24:MI:SS'), '1', to_date('2024-12-05 19:00:00', 'SYYYY-MM-DD HH24:MI:SS'), '0');
