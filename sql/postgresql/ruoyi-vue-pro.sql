...
INSERT INTO infra_config (id, category, type, name, config_key, value, visible, remark, creator, create_time, updater, update_time, deleted) VALUES (8, 'url', 2, 'SkyWalking 监控的地址', 'url.skywalking', 'http://localhost:8080', '1', '', '1', '2023-04-07 13:41:16', '1', '2023-04-07 14:57:03', '0');
...
-- 已移除推广菜单: Boot 开发文档 (ID: 2159)
-- 已移除推广菜单: Cloud 开发文档 (ID: 2160)
...
-- ----------------------------
-- Sequence for report_go_view_project
-- ----------------------------
