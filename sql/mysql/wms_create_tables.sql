CREATE TABLE IF NOT EXISTS `wms_warehouse` (
    ...
    PRIMARY KEY (`id`)
) COMMENT 'WMS 仓库表' ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `wms_merchant` (
    ...
    `tenant_id` bigint NOT NULL DEFAULT '0',
    PRIMARY KEY (`id`)
) COMMENT 'WMS 往来企业表' ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `wms_item_brand` (
    ...
    `tenant_id` bigint NOT NULL DEFAULT '0',
    PRIMARY KEY (`id`)
) COMMENT 'WMS 商品品牌表' ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `wms_item_category` (
    ...
    `tenant_id` bigint NOT NULL DEFAULT '0',
    PRIMARY KEY (`id`)
) COMMENT 'WMS 商品分类表' ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `wms_item` (
    ...
    `tenant_id` bigint NOT NULL DEFAULT '0',
    PRIMARY KEY (`id`)
) COMMENT 'WMS 商品表' ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `wms_item_sku` (
    ...
    `tenant_id` bigint NOT NULL DEFAULT '0',
    PRIMARY KEY (`id`)
) COMMENT 'WMS 商品 SKU 表' ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
) COMMENT 'WMS 库存表' ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `wms_inventory_history` (
    ...
    `tenant_id` bigint NOT NULL DEFAULT '0',
    PRIMARY KEY (`id`)
) COMMENT 'WMS 库存流水表' ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `wms_receipt_order` (
    ...
    `tenant_id` bigint NOT NULL DEFAULT '0',
    PRIMARY KEY (`id`)
) COMMENT 'WMS 入库单表' ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `wms_receipt_order_detail` (
    ...
    `tenant_id` bigint NOT NULL DEFAULT '0',
    PRIMARY KEY (`id`)
) COMMENT 'WMS 入库单明细表' ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `wms_shipment_order` (
    ...
    `tenant_id` bigint NOT NULL DEFAULT '0',
    PRIMARY KEY (`id`)
) COMMENT 'WMS 出库单表' ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `wms_shipment_order_detail` (
    ...
    `tenant_id` bigint NOT NULL DEFAULT '0',
    PRIMARY KEY (`id`)
) COMMENT 'WMS 出库单明细表' ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `wms_movement_order` (
    ...
    `tenant_id` bigint NOT NULL DEFAULT '0',
    PRIMARY KEY (`id`)
) COMMENT 'WMS 移库单表' ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `wms_movement_order_detail` (
    ...
    `tenant_id` bigint NOT NULL DEFAULT '0',
    PRIMARY KEY (`id`)
) COMMENT 'WMS 移库单明细表' ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `wms_check_order` (
    ...
    `tenant_id` bigint NOT NULL DEFAULT '0',
    PRIMARY KEY (`id`)
) COMMENT 'WMS 盘库单表' ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `wms_check_order_detail` (
    ...
    `tenant_id` bigint NOT NULL DEFAULT '0',
    PRIMARY KEY (`id`)
) COMMENT 'WMS 盘库单明细表' ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
