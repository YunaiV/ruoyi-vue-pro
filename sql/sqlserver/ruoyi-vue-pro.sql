...
EXEC sp_addextendedproperty
'MS_Description', N'是否自动授权',
'SCHEMA', N'dbo',
'TABLE', N'system_oauth2_client',
'COLUMN', N'auto_approve'
GO
...
INSERT INTO [dbo].[system_oauth2_client] ([id], [client_id], [secret], [name], [logo], [description], [status], [access_token_validity_seconds], [refresh_token_validity_seconds], [redirect_uris], [auto_approve], [authorized_grant_types], [scopes], [authorities], [resource_ids], [additional_information], [creator], [create_time], [updater], [update_time], [deleted]) VALUES (N'1', N'default', N'admin123', N'芋道源码', N'http://test.yudao.iocoder.cn/a5e2e244368878a366b516805a4aabf1.png', N'我是描述', N'0', N'180', N'8640', N'["https://www.iocoder.cn","https://doc.iocoder.cn"]', N'1', N'["password","authorization_code","implicit","refresh_token"]', N'["user_info"]', N'["system:user:query"]', N'[]', N'{}', N'1', N'2022-05-11 21:47:12.0000000', N'1', N'2022-05-13 10:50:16.9620000', N'0')
GO
...
INSERT INTO [dbo].[system_users] ([id], [username], [password], [nickname], [remark], [dept_id], [post_ids], [email], [mobile], [sex], [avatar], [status], [login_ip], [login_date], [creator], [create_time], [updater], [update_time], [tenant_id], [deleted]) VALUES (N'1', N'admin', N'$2a$10$0acJOIk2D25/oC87nyclE..0lzeu9DtQ/n3geP4fkun/zIVRhHJIO', N'芋道源码', N'管理员', N'103', N'[1]', N'aoteman@126.com', N'15612345678', N'1', N'http://test.yudao.iocoder.cn/48934f2f-92d4-4250-b917-d10d2b262c6a', N'0', N'127.0.0.1', N'2022-05-13 10:48:10.2610000', N'admin', N'2021-01-05 17:03:47.0000000', NULL, N'2022-05-13 10:48:10.2640000', N'1', N'0')
GO
...
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[infra_api_access_log]', RESEED, 40547)
GO
...
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[infra_api_error_log]', RESEED, 2020)
GO
...
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[system_error_code]', RESEED, 15455)
GO
...
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[system_login_log]', RESEED, 23)
GO
...
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[system_oauth2_access_token]', RESEED, 3)
GO
...
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[system_oauth2_refresh_token]', RESEED, 2)
GO
...
-- ----------------------------
DBCC CHECKIDENT ('[dbo].[system_operate_log]', RESEED, 18)
GO
